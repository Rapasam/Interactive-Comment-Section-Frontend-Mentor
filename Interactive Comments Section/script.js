...
const createCommentNode = (commentObject) => {
  ...
  cBody.textContent = commentObject.content;
  if (commentObject.replyingTo) commentNode.querySelector(".reply-to").textContent = "@" + commentObject.replyingTo;
  ...
  if (commentObject.user.username == data.currentUser.username) {
      ...
      commentNode.querySelector(".edit").addEventListener("click", () => {
          if (cBody.getAttribute("contenteditable") == false || cBody.getAttribute("contenteditable") == null) {
